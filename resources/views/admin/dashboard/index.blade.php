...
@section('content')						
	...
	<div class="row">
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12 font-weight-bold">{{ __('Free Minutes Used') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12 font-weight-bold">{{ __('Paid Minutes Used') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12 font-weight-bold">{{ __('Purchased Minutes') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<p class=" mb-3 fs-12 font-weight-bold">{{ __('All Transcribe Tasks') }} <span class="text-muted">({{ __('Current Month') }})</span></p>
			...
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body">
					<div class="row mb-5 mt-2">	
						...
						<div class="col-xl-3 col-12 ">
							<p class=" mb-1 fs-12">{{ __('Total Minutes Purchased') }}</p>
							<h3 class="mb-0 fs-20 number-font">{{ number_format($total_data_yearly['total_purchased_minutes'][0]['data']) }}</h3>
						</div>
						<div class="col-xl-3 col-12 ">
							<p class=" mb-1 fs-12">{{ __('Total Purchased Minutes Used') }}</p>
							<h3 class="mb-0 fs-20 number-font">{{ number_format((float)$total_data_yearly['total_purchased_minutes_used'][0]['data'] / 60, 2) }}</h3>
						</div>
					</div>
					<div class="row">
...
@section('js')
	...
	<script type="text/javascript">
		$(function() {
			...
			var audio_current_month = JSON.parse(`<?php echo $percentage['task_current']; ?>`);
			...
			var audio_past_month = JSON.parse(`<?php echo $percentage['task_past']; ?>`);
			...
			document.getElementById('free_minutes_past').innerHTML = (free_past_total / 60).toFixed(2);
			document.getElementById('paid_minutes_past').innerHTML = (paid_past_total / 60).toFixed(2);
			document.getElementById('purchased_minutes_past').innerHTML = new Intl.NumberFormat().format(purchased_past_total);
			document.getElementById('tasks_past').innerHTML = new Intl.NumberFormat().format(audio_past_total);

			document.getElementById('free_minutes').innerHTML = free_change;
			document.getElementById('paid_minutes').innerHTML = paid_change;
			document.getElementById('purchased_minutes').innerHTML = purchased_change;
