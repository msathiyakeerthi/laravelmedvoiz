				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0"><span class="number-font fs-20">{{ number_format($total_data_monthly['purchased_minutes'][0]['data']) }}</span><span class="ml-2 text-muted fs-11 data-percentage-change"><span class="fs-12" id="purchased_chars_difference"></span> {{ __('this month') }}</span></h2>
				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0"><span class="number-font fs-20">{{ number_format((float)$total_data_monthly['paid_minutes'][0]['data'] / 60, 2) }}</span><span class="ml-2 text-muted fs-11 data-percentage-change"><span class="fs-12" id="purchased_chars_used_difference"></span> {{ __('this month') }}</span></h2>
						</div>
