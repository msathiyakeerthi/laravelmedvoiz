		...
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				<ol class="breadcrumb mb-2">
					...
					<li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('Prepaid Plan') }}</a></li>
				</ol>
			</ol>
		</div>
	</div>
				...
				<div class="card-body pt-5">		
					...
					<div class="row pt-5">
						...
						<div class="col-lg-4 col-md-4 col-12">
							...
							<span class="fs-14">{{ ucfirst($id->minutes) }}</span>
						</div>
						<div class="col-lg-4 col-md-4 col-12">
							<h6 class="font-weight-bold mb-1">{{ __('Bonus Minutes') }}: </h6>
					...
					<div class="border-0 text-right mb-2 mt-7">
						<a href="{{ route('admin.finance.prepaid') }}" class="btn btn-cancel mr-2">{{ __('Return') }}</a>
