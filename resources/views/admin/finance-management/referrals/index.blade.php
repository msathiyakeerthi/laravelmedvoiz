		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				<div class="card-body">
					...
					<p class=" mb-3 fs-12 font-weight-bold mt-1">{{ __('Total Referral STT Bonus Minutes') }} <span class="text-muted">({{ __('All Time') }})</span></p>
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">								
										<div class="input-box">								
											<h6>{{ __('Allocate STT Gift Minutes') }} <span class="text-muted">({{ __('Only for Email Verified New Users') }})</span></h6>
											<div class="form-group">							    
