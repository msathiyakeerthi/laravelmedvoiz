									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Use PayPal Subscription <i class="ml-2 fa fa-info info-notification" data-toggle="tooltip" data-placement="top" title="Subscription plan for Paypal Gateway requires Plan ID created in your Paypal account."></i></span>
											</label>
										</div>
									</div>
								</div>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Use Stripe Subscription <i class="ml-2 fa fa-info info-notification" data-toggle="tooltip" data-placement="top" title="Subscription plan for Stripe Gateway requires Product ID created in your Stripe account."></i></span>
											</label>
										</div>
									</div>
								</div>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Use Paystack Subscription <i class="ml-2 fa fa-info info-notification" data-toggle="tooltip" data-placement="top" title="Subscription plan for Paystack Gateway requires Plan ID created in your Paystack account."></i></span>
											</label>
										</div>
									</div>
								</div>
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label class="custom-switch">
												...
												<span class="custom-switch-indicator"></span>
												<span class="custom-switch-description">Use Razorpay Subscription <i class="ml-2 fa fa-info info-notification" data-toggle="tooltip" data-placement="top" title="Subscription plan for Razorpay Gateway requires Plan ID created in your Razorpay account."></i></span>
											</label>
										</div>
									</div>
								</div>
