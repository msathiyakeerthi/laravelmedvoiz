				...
				<div class="card-body pt-5">									
					<form action="{{ route('admin.finance.subscriptions.update', $id) }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row mt-2">							
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('PayPal Plan ID') }} <span class="text-danger">({{ __('Required for Paypal Gateway') }}) <i class="ml-2 fa fa-info info-notification" data-toggle="tooltip" data-placement="top" title="You can get Paypal Plan ID in your Paypal account. Refer to the documentation if you need help with creating one."></i></span></h6>
									<div class="form-group">							    
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('Stripe Plan ID') }} <span class="text-danger">({{ __('Required for Stripe Gateway') }}) <i class="ml-2 fa fa-info info-notification" data-toggle="tooltip" data-placement="top" title="You can get Stripe Product ID in your Stripe account. Refer to the documentation if you need help with creating one."></i></span></h6>
									<div class="form-group">							    
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('Paystack Plan ID') }} <span class="text-danger">({{ __('Required for Paystack Gateway') }}) <i class="ml-2 fa fa-info info-notification" data-toggle="tooltip" data-placement="top" title="You can get Paystack Plan ID in your Paystack account. Refer to the documentation if you need help with creating one."></i></span></h6>
									<div class="form-group">							    
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('Razorpay Plan ID') }} <span class="text-danger">({{ __('Required for Razorpay Gateway') }}) <i class="ml-2 fa fa-info info-notification" data-toggle="tooltip" data-placement="top" title="You can get Razorpay Plan ID in your Razorpay account. Refer to the documentation if you need help with creating one."></i></span></h6>
									<div class="form-group">							    
