				...
				<div class="card-body">
					...
					<form action="{{ route('admin.settings.registration.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-12">							
								<div class="input-box">	
									<h6>{{ __('New User Email Verification') }} <i class="ml-2 fa fa-info info-notification" data-toggle="tooltip" data-placement="top" title="Before enabling this feature, make sure your SMTP settings are correct and working properly."></i></h6>
