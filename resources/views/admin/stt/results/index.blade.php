	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('Medical Transcribe Results') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
...
@section('content')	
		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('All Processed Medical Transcribe Reults') }}</h3>
	...
	<!-- TRANSCRIBE MODAL -->
	<div class="modal fade transcript-modal" id="transcriptModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLongTitle">Transcript Results</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
				</button>
				</div>
				<div class="modal-buttons">
					<span><a href="#" id="rt-download-txt" data-toggle="tooltip" data-placement="top" title="Download as Text File"><i class="fa fa-cloud-download"></i></a></span>
					<span><a href="#" id="rt-save" data-id="" data-toggle="tooltip" data-placement="top" title="Save Edited Text"><i class="fa fa-floppy-o"></i></a></span>
				</div>
				<span class="save-status" id="rt-save-status"></span>
				<div class="modal-body">
				<textarea class="form-control" id="textarea" rows="10" autofocus></textarea>
				</div>     
			</div>
		</div>
	</div> 
	...
	<!-- RAW JSON MODAL -->
	<div class="modal fade transcript-modal" id="jsonModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLongTitle">Raw JSON Results</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
				</button>
				</div>
				<div class="modal-buttons">
					<span><a href="#" id="rj-download-txt" data-toggle="tooltip" data-placement="top" title="Download as JSON File"><i class="fa fa-cloud-download"></i></a></span>
				</div>
				<div class="modal-body">
	...
	<div class="modal fade transcript-modal" id="speakerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLongTitle">Speaker Identification Results</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
				</button>
				</div>
				<div class="modal-buttons">
					<span><a href="#" id="si-download-txt" data-toggle="tooltip" data-placement="top" title="Download as Text File"><i class="fa fa-cloud-download"></i></a></span>
				</div>
				<div class="modal-body">		
					<textarea class="form-control" id="showSpeakerIdentity" rows="10" autofocus></textarea>
...
@section('js')
	...
	<script src="{{URL::asset('js/results-admin.js')}}"></script>
