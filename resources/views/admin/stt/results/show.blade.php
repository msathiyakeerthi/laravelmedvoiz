	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="{{route('admin.stt.results')}}"> {{ __('All Transcribe Results') }}</a></li>
					...
					<div class="row">
						...
						<div class="col-sm-12 text-center">
							<div id="controls" class="mt-5">
								...
								<a href="{{ route('admin.stt.results') }}" class="btn btn-primary pl-5 pr-5 mr-2 control-button-right">{{ __('Return') }}</a>								
							</div>
						</div>
					</div>
				</div>
