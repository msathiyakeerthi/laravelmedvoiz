...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Add Minutes') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('Add Minutes') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-xl-5 col-lg-5 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Add New Minutes') }}</h3>
				</div>
				<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12">
								<div>
									...
									<p class="fs-12 font-weight-bold">{{ __('Available Minutes') }}: <span class="font-weight-normal ml-2">{{ number_format($user->available_minutes) }}</span></p>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-12">
								<div class="input-box">
									<div class="form-group">
										<label class="form-label fs-12">{{ __('Total New Minutes') }}</label>
										<input type="text" class="form-control @error('minutes') is-danger @enderror" name="minutes">
										@error('minutes')
