                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            @if (config('settings.oauth_login') == 'enabled')
                                ...
                                <div class="actions-total text-center">
                                    @if(config('services.facebook.enable') == 'on')<a href="{{ url('/auth/redirect/facebook') }}" class="btn mr-2" id="login-facebook"><i class="fa fa-facebook-f"></i></a>@endif
                                    @if(config('services.twitter.enable') == 'on')<a href="{{ url('/auth/redirect/twitter') }}" class="btn mr-2" id="login-twitter"><i class="fa fa-twitter"></i></a>@endif	
                                    @if(config('services.google.enable') == 'on')<a href="{{ url('/auth/redirect/google') }}" class="btn mr-2" id="login-google"><i class="fa fa-google"></i></a>@endif	
                                    @if(config('services.linkedin.enable') == 'on')<a href="{{ url('/auth/redirect/linkedin') }}" class="btn mr-2" id="login-linkedin"><i class="fa fa-linkedin"></i></a>@endif	
                                </div>
