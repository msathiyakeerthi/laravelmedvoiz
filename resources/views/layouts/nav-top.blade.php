                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        ...
                        <a class="dropdown-item d-flex" href="{{ route('user.subscriptions') }}">
                            <span class="profile-icon zmdi zmdi-balance-wallet"></span>
                            <div class="fs-12">{{ __('Increase Balance') }}</div>
                        </a>
                        <a class="dropdown-item d-flex" href="{{ route('user.stt.results') }}">
                            <span class="profile-icon mdi icon-medical-i-medical-records"></span>
                            <div class="fs-12">{{ __('Transcribe Results') }}</div>
                        </a>
