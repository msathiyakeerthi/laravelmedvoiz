		...
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				<div class="card-body">
					...
					<p class=" mb-3 fs-12 font-weight-bold mt-1">{{ __('Available Minutes') }}</p>
					<h2 class="mb-0"><span class="number-font-chars">{{ number_format(auth()->user()->available_minutes) }}</span></h2>									
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				<div class="card-body">
					...
					<p class=" mb-3 fs-12 font-weight-bold mt-1">{{ __('Total Minutes Purchased') }}</p>
					<h2 class="mb-0"><span class="number-font-chars">{{ number_format($total_data['total_purchased_minutes'][0]['data']) }}</span></h2>
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				<div class="card-body">
					...
					<p class=" mb-3 fs-12 font-weight-bold mt-1">{{ __('Total Minutes Used') }}</p>
					<h2 class="mb-0"><span class="number-font-chars">{{ number_format((float)$total_data['total_minutes_used'][0]['data'] / 60, 2) }}</span></h2>
				</div>
			</div>
		</div>	
	</div>
