	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="{{route('user.cases')}}"> {{ __('Patient & Case Data') }}</a></li>
					...
					<div class="row">
						...
						<div class="col-sm-12 text-center">
							<div id="controls" class="mt-5">
								...
								<a href="{{ route('user.cases') }}" class="btn btn-primary pl-5 pr-5 mr-2 control-button-right">{{ __('Return') }}</a>								
							</div>
						</div>
					</div>
				</div>
