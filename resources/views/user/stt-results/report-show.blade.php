        ...
        <div class="col-md-12 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body pt-4 pb-5">
					<h6 class="mb-3 fs-12 text-primary font-weight-bold">Medical Report</h6>
					<div class="row">
						<div class="col-sm-12">
							<div class="outer-box">
								<form action="{{ route('user.stt.results.report-update', ['id' => $transcriberesult->id]) }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="transcript"></label>
                                        <textarea class="form-control" id="transcript" name="answer" rows="10">{{ $transcriberesult->answer }}</textarea>
                                    </div>
                                    <button type="submit" class="btn btn-primary">Update</button>
                                    <button type="button" class="btn btn-primary" id="copy" style="background-color: black; color: white">Copy</button>
                                </form>
							</div>
						</div>
					</div>
