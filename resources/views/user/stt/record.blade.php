...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">{{ __('Record & Transcribe') }}</h4>
		<ol class="breadcrumb mb-2">
			...
			<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('Record & Transcribe') }}</a></li>
		</ol>
	</div>
</div>
<!-- END PAGE HEADER -->
...
@section('content')
	<div class="row">
		<div class="col-lg-3 col-md-12 col-sm-12">
			<form id="transcribe-record" action="{{ route('user.stt.transcribe') }}" method="POST" enctype="multipart/form-data">
				@csrf
				...
				<div class="card border-0">
					<div class="card-body pt-6 pb-6">
						...
						<div id="record-actions" class="text-center">							
							<!-- AUDIO FORMAT-->
							<div id="audio-format">Audio Format: 2 channel PCM @ 48kHz</div>

							<!-- AUDIO RECORDER-->
							<div id="record-buttons">
								<div><button class="controls active" id="record"><i class="fa fa-microphone"></i>Record</button></div>
								<div><button class="controls is-blocked" id="stop" disabled="true"><i class="fa fa-stop-circle"></i>Stop</button></div>
							</div>
						...
						<div class="row">
							...
							<div class="col-sm-12" id="removable-speaker">
								<div id="speakers-box">
									...
									<select id="speakers" name="speakers" data-placeholder="Select max number of speakers in the recording">
		...
		<div class="col-lg-9 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Record & Transcribe Tasks') }} <span class="text-muted">({{ __('Current Day') }})</span></h3>
